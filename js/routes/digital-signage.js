...
export default async ({ signal, stack }) => {
	...
	scrollSnap.append(
		...
		forecast,
		el`<img src="https://i.imgur.com/SmOb0Pu.webp" width="1305" height="729" alt="Diabetic Cooking Class" crossorigin="anonymous" referrerpolicy="anonymous" decoding="lazy" loading="lazy" />`,
		...
		el`<img src="https://i.imgur.com/1m655aA.webp" width="1305" height="690" alt="Mobile Medical Unit" crossorigin="anonymous" referrerpolicy="no-referrer" decoding="auto" loading="lazy" />`,
