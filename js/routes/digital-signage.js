...
export default async ({ signal, stack }) => {
	...
	scrollSnap.append(
		...
		el`<img src="https://i.imgur.com/Z9EChIR.webp" width="1024" height="541" loading="lazy" crossorigin="anonymous" referrerpolicy="no-referrer" alt="KRHC Mobile Medical Unit" />`,
