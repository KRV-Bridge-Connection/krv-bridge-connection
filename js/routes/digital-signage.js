...
export default async ({ signal, stack }) => {
	...
	scrollSnap.append(
		...
		forecast,
		el`<img src="https://i.imgur.com/hvKw1WV.webp" width="1305" height="729" alt="Diabetic Cooking Class" crossorigin="anonymous" referrerpolicy="anonymous" decoding="lazy" loading="lazy" />`,
