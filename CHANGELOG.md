...
### Changed
- Enhance security
- Update partners/resources directory
- Misc content updates

## [v3.0.1] - 2026-06-12

### Added
- Add `allowScripts` and `strict-allow-scripts=true`
...
### Added
- Add peridic sync to sync partners IDB
- Implement most basic analytics (view count with datetimes for querying)
...
### Changed
- Dependency updates & service worker updates

## [v2.0.17] - 2026-04-07

### Added
- Implement CSS `@layer`s

### Changed
- Update home page content/sections

### Fixed
- Fixed icons on partners page
...
- Remove Oasis links in pantry
- Update FAQ and other content

## [v2.0.13] - 2026-02-08

### Added
- Add redirect support on resources
- Require authentication on admin directory

### Fixed
- Fix misc visual issues in TV presentation route
